...
<head>
  ...
  <title>Cake Factory - <?= $title?></title>
        ...
        <div class="login-box-body">
            ...
            <form action="" method="post">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" id="admin" name="admin" placeholder="Email or Username" value="<?= set_value('admin'); ?>">

                    <?= form_error('admin', '<small class="text-danger">', '</small>'); ?>
