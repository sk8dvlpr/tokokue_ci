            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?= base_url('assets/img/users/'. $data_session['photo_path']); ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?= $data_session['nama_depan'] . " " . $data_session['nama_belakang'] ?></span>
                        </a>
                        <ul class="dropdown-menu">

                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?= base_url('assets/img/users/' . $data_session['photo_path']); ?>" class="img-circle" alt="User Image">
