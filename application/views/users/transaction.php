                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($transaction['status_pengiriman'] != FALSE && $transaction['status_sampai'] == FALSE) : ?>
                                                    ...
                                                    <a href="<?= base_url('users/transactions/order_arrived/').$transaction['id_transaksi'] ?>" role="button" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure?')"><i class="fa fa-check"></i> Pesanan Diterima</a>
